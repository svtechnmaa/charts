...
- Replacing `bitnami/postgresql` with `bitnamilegacy/postgresql-repmgr` which includes and configures [repmgr](https://repmgr.org/). Repmgr ensures standby nodes assume the primary role when the primary node is unhealthy.
...
| `postgresql.image.repository`                                | PostgreSQL with Repmgr image repository                                                                                                                                                                       | `bitnamilegacy/postgresql-repmgr` |
...
| `pgpool.image.repository`                                | Pgpool image repository                                                                                                                  | `bitnamilegacy/pgpool`     |
...
| `volumePermissions.image.tag`                    | Init container volume-permissions image tag                                                                                       | `11`      |
